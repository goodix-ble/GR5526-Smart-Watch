...
enum {
    ...
    LV_IMG_CF_GDX_RGB565,                /**< User holder encoding format.*/
    LV_IMG_CF_GDX_RGB565_CHROMA_KEYED,   /**< User holder encoding format.*/
    LV_IMG_CF_GDX_RGBA8888,              /**< User holder encoding format.*/
    LV_IMG_CF_GDX_RGBA8888_CHROMA_KEYED, /**< User holder encoding format.*/
    LV_IMG_CF_GDX_TSC4,                  /**< User holder encoding format.*/
    LV_IMG_CF_GDX_TSC6a,                 /**< User holder encoding format.*/
    LV_IMG_CF_GDX_A8,                    /**< User holder encoding format.*/
#endif
