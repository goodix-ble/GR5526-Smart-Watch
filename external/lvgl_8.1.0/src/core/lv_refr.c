...
void _lv_disp_refr_timer(lv_timer_t * tmr)
{
    ...
    // For the LVGL WMS conflict solution
    extern bool lv_refresh_enable_get(void);
    if (!lv_refresh_enable_get()) return;
#endif
...
#endif // RENDER COMMIT All in One
}
