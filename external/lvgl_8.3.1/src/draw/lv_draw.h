...
typedef struct _lv_draw_ctx_t  {
    ...
    void (*draw_label)(struct _lv_draw_ctx_t * draw_ctx, const lv_draw_label_dsc_t * dsc, 
    ...
    /* add transform patch for lvgl */
    bool is_transform_buff;
    bool is_blending_transform_buff;
    size_t  transform_buff_pixel_bytes;
#endif
