...
#elif LV_USE_GPU_GR552x
    #include "../draw/gr5526_gpu/lv_gpu_gr5526.h"
#else
...
void lv_disp_drv_init(lv_disp_drv_t * driver)
{
    ...
    driver->hor_res          = DISP_HOR_RES;
    driver->ver_res          = DISP_VER_RES;
...
#elif LV_USE_GPU_GR552x
    driver->draw_ctx_init   = lv_draw_gr5526_ctx_init;
    driver->draw_ctx_deinit = lv_draw_gr5526_ctx_deinit;
