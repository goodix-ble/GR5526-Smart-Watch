...
typedef struct _lv_font_t {
    ...
    const void * origin_dsc;            /**< Store implementation specific or run_time data or caching here*/
    lv_coord_t origin_line_height;      /**< The real line height where any text fits*/
    lv_coord_t origin_base_line;        /**< Base line measured from the top of the line_height*/
#endif
} lv_font_t;
...
/**
 * Get the origin descriptor of a glyph
 * @param font_p pointer to font
 * @param dsc_out store the result descriptor here
 ...
 *         false: the letter was not found, no data is loaded to `dsc_out`
 */
bool lv_font_get_glyph_origin_dsc(const lv_font_t * font_p, lv_font_glyph_dsc_t * dsc_out, uint32_t letter,
                           uint32_t letter_next);
...
#if GR552X_GPU_FONT_SUPPORT
    #define LV_FONT_CONST
    #define GR552X_FONT_DECLARE(font_name)  extern LV_FONT_CONST lv_font_t font_name;
    #define LV_FONT_DECLARE(font_name)      extern LV_FONT_CONST lv_font_t font_name;
#else
    #define LV_FONT_CONST                   const
    #define GR552X_FONT_DECLARE(font_name)
    #define LV_FONT_DECLARE(font_name)      extern LV_FONT_CONST lv_font_t font_name;
#endif
