...
{
    lv_obj_t *p_window = lv_layout_setting_create_common_title(parent, &lv_font_montserrat_36, "Cardflow Style");
    ...
    lv_roller_set_selected(p_roller, lv_layout_get_cardflow_style() ? 1 : 0, LV_ANIM_OFF);
